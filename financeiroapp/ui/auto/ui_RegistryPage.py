...
class Ui_RegistryPage(object):
    def setupUi(self, RegistryPage):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 1045, 540))
        ...
        self.verticalLayout = QVBoxLayout(self.widHistoricoTable)
        ...
        self.gridLayout.addWidget(self.lineTitulo, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineDescricao, 5, 2, 1, 1)

        self.cbConta = QCheckBox(self.frame)
        self.cbConta.setObjectName(u"cbConta")

        self.gridLayout.addWidget(self.cbConta, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinValor, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.widget_2, 10, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.comboConta, 6, 2, 1, 1)

        self.comboCartao = QComboBox(self.frame)
        self.comboCartao.setObjectName(u"comboCartao")

        self.gridLayout.addWidget(self.comboCartao, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.dtEditDatahora, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinRecorrencia, 9, 2, 1, 1)
        ...
        self.cbCartao = QCheckBox(self.frame)
        self.cbCartao.setObjectName(u"cbCartao")

        self.gridLayout.addWidget(self.cbCartao, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.cbRecorrencia, 9, 1, 1, 1)
        ...
        self.verticalLayout_2 = QVBoxLayout(self.widAgendadosTable)
...
#endif // QT_CONFIG(tooltip)
        self.cbRecorrencia.setText("")
        self.label_7.setText(QCoreApplication.translate("RegistryPage", u"Data/Hora", None))
#if QT_CONFIG(tooltip)
        self.label_8.setToolTip(QCoreApplication.translate("RegistryPage", u"Ao ativar a recorr\u00eancia, o registro ser\u00e1 agendado para ocorrer a cada N dias. \u00c9 poss\u00edvel visualiz\u00e1-los na tabela Registros Agendados", None))
#endif // QT_CONFIG(tooltip)
        self.label_8.setText(QCoreApplication.translate("RegistryPage", u"Recorr\u00eancia", None))
